...
# exactly three odd numbers. Additionally, the numbers in the series must sum
# to 47.
#
...
# This method is using an assignment as the conditional check for the ternary
# operator in the last line. This assignment will always return true, as all
# variable assignments do, this negating this checks effectiveness.
# When the ternary conditional is modified to contain an equivalency operator (==),
